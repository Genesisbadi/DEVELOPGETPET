...
<th style="text-align:center;" width="30%">Organization Name</th>
<th style="text-align:center;" width="30%">Organization Manager</th>
...
<tbody>
<?php
$sql="SELECT * from animal_welfare_agency";
...
<td><?php echo htmlentities($result->OrganizationManager);?></td>
...
if(isset($_POST['delete']))
{
  foreach ($_POST['ID'] as $ID){
    ...
    echo "<script type ='text/javascript'> document.location='http://localhost/GETPET/web/AnimalWelfareAgency.php'</script>";
    }
}

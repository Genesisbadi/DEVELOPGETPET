...
$query=$dbh->prepare("SELECT COUNT(ID) FROM pet_owner_rescuer");
$query->execute();

$pet_owner_rescuer=$query->fetchColumn();
...
<head>
    ...
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="img/getpet.ico">
    <!-- Google Fonts
		============================================ -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                    <h1 style="color:white">GetPet</h1>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter"><?php echo $pet_owner_rescuer; ?></span></h2>
                            <p>Total Pet Owner/Rescuer</p>
                        </div>
                        <div class="sparkline-bar-stats1"><?php echo $pet_owner_rescuer; ?>,<?php echo $pet_owner_rescuer; ?>,<?php echo $pet_owner_rescuer; ?>,<?php echo $pet_owner_rescuer; ?>,<?php echo $pet_owner_rescuer; ?>,<?php echo $pet_owner_rescuer; ?>,<?php echo $pet_owner_rescuer; ?>,<?php echo $pet_owner_rescuer; ?>,<?php echo $pet_owner_rescuer; ?>,<?php echo $pet_owner_rescuer; ?>,<?php echo $pet_owner_rescuer; ?>,<?php echo $pet_owner_rescuer; ?></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter"><?php echo $animal_welfare_agency;?></span></h2>
                            <p>Total Animal Welfare Agency</p>
                        </div>
                        <div class="sparkline-bar-stats2"><?php echo $animal_welfare_agency;?>,<?php echo $animal_welfare_agency;?>,<?php echo $animal_welfare_agency;?>,<?php echo $animal_welfare_agency;?>,<?php echo $animal_welfare_agency;?>,<?php echo $animal_welfare_agency;?>,<?php echo $animal_welfare_agency;?>,<?php echo $animal_welfare_agency;?>,<?php echo $animal_welfare_agency;?>,<?php echo $animal_welfare_agency;?>,<?php echo $animal_welfare_agency;?>,<?php echo $animal_welfare_agency;?></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">

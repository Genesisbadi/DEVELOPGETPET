...
$sql="INSERT INTO animal_welfare_agency(OrganizationName,OrganizationManager,Logo,ContactNo,Address,Email,Password,Role)VALUES(:OrganizationName,:OrganizationManager,:Logo,:ContactNo,:Address,:Email,:Password,'AnimalWelfareAgency')";
